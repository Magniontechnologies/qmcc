...
<head>
        ...
        <!-- :: Favicon -->
        <link rel="icon" type="image/png" href="assets/images/logo/qmcc.png">


        <!-- :: Title -->
        <title>QMCC-Industrial Inspection Services</title>
                    ...
                    <div class="content-box d-flex align-items-center justify-content-between">
                        <div class="logo">
                            <a href="index.php" class="logo-nav">
                                <img class="img-fluid one" src="assets/images/logo/qmcc2.png" alt="01 Logo">
                                <img class="img-fluid two" src="assets/images/logo/qmcc2.png" alt="02 Logo">
                            </a>
                        ...
                        <div class="nav-bar-links" id="open-nav-bar-menu">
                            <ul class="level-1">
                                   ...
                                   <a href="#" class="link-level-1 ">Services</a>
                                    <ul class="level-2">
                                        <li class="item-level-2">
                                            <a class="link-level-2" href="service1.php">QMCC Engineering Services</a>
                                        </li>
                                         <li class="item-level-2">
                                            <a class="link-level-2" href="service2.php">Quality & Inspection Services</a>
                                        </li>
                                        <li class="item-level-2">
                                            <a class="link-level-2" href="service3.php">Welding Engineering & NDT Consultancy</a>
                                        </li>
                                        <!-- <li class="item-level-2">
                                            <a class="link-level-2" href="service4.php">Design Review & Detail Engineering</a>
                                        </li> -->
                                    </ul>
                                </li>
                                <li class="item-level-1">
                                    <a href="training.php" class="link-level-1">Training</a>
                                </li>
                                <li class="item-level-1">
                                ...
                                <li class="item-level-1">
                                    <a href="contact.php" class="link-level-1">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!--         <div class="menu-box">
            <div class="inner-menu">
                <div class="website-info">
                    <a href="index.php" class="logo"><img class="img-fluid" src="assets/images/logo/02_logo.png" alt="02 Logo"></a>
